...
<template>
      <!-- ARTICLE SECTION -->
      <main class=" flex mt-[40px] mb-[80px] md:mt-[60px] md:flex items-center justify-center">
        <div v-for="card in cards">
            <div class="flex flex-col md:flex-row items-center justify-center" v-show="this.$route.params.name == card.name">
                <!-- IMG -->
                <div class="flex justify-center items-center w-[400px] h-[400px] md:w-[400px] lg:w-[400px] lg:h-[450px] ">
                    <img :src="'.' + card.img" :alt="card.title" class="w-[200px] md:w-[250px] lg:w-[300px]">
                </div>
                <!-- TEXT CONTENT -->
                <div class="text-center md:text-left text-dark-gray w-[350px] md:w-[400px] lg:w-[500px] flex flex-col justify-around">
                    <p class="mb-[20px] md:mb-[0px] text-[16px] md:text-[18px] font-bold ">{{ card.price }} €</p>
                    <div class="mb-[50px]">
                        <h2 class="text-[30px] text-black-gray font-bold md:text-[36px] lg:text-[40px]"> {{ card.title }} </h2>
                        <p class="text-[16px] text-gray-p"> {{ card.description }} </p>
                    </div>
                    <!-- BTN -->
    ...
    <section>
            ...
            <ul class="overflow-x-auto h-[480px] flex pb-2 pt-5">
                ...
                <li v-for="items in cards" class="ml-5">
                    <!-- CARD -->
                    <div class="w-[300px] h-[420px] flex flex-col justify-center items-center shadow-xl rounded-lg "v-show="this.$route.params.name !== items.name">
                        ...
                        <!-- CONTAINER ICONS-->
                        <div class="w-[250px] flex justify-between items-center  px-[10px]">

                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"fill="#d1d8e0" class="w-6 h-6">
