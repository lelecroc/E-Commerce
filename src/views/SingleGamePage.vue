...
<template>
    ...
    <main class="flex my-[100px] md:flex items-center justify-center">
        ...
        <div v-for="game in games">
            <div class="flex flex-col md:flex-row items-center justify-center"
                v-show="this.$route.params.name == game.id">
                ...
                <div
                    ...
                    <div class="mb-[30px]">
                        <h2 class="text-[30px] text-black-gray font-bold md:text-[36px] lg:text-[40px]"> {{ game.title
                            }} </h2>
    ...
    <section>
        ...
        <ul class="overflow-x-auto h-[480px] flex pb-2 pt-5">
            ...
            <li v-for="items in games" class="ml-5">
                <!-- CARD -->
